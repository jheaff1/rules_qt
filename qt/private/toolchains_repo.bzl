...
def _resolved_toolchain_impl(ctx):
    toolchain_info = ctx.toolchains["@rules_qt//qt:toolchain_type"]
    return [
        toolchain_info,
        toolchain_info.default,
        toolchain_info.qtinfo,
...
resolved_toolchain = rule(
    ...
    toolchains = ["@rules_qt//qt:toolchain_type"],
...
# By default all these toolchains are registered by the qt_register_toolchains macro
...
toolchain(
    ...
    toolchain = "@{user_repository_name}_{platform}//:qt_toolchain",
